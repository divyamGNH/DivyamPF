    ...
    <>
      ...
      <style>{`
        .global-mask {
          ...
          /* circular hole */
          -webkit-mask-image: radial-gradient(circle, transparent 60%, transparent 61%);
          mask-image: radial-gradient(circle, transparent 60%, transparent 61%);
          ...
          z-index: 2; /* BETWEEN hidden (1) and normal text (3) */
        }
      `}</style>
    </>
  );
