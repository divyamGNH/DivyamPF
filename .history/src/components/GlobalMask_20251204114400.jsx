    ...
    <>
      ...
      <style>{`
        .global-mask {
          ...
          /* circular hole */
          -webkit-mask-image: radial-gradient(circle, orange 60%, transparent 61%);
          mask-image: radial-gradient(circle, orange 60%, transparent 61%);
        ...
        //   mask-repeat: no-repeat;
          ...
          z-index: 1; /* BETWEEN hidden (1) and normal text (3) */
        }
      `}</style>
    </>
  );
