const TimelineItem = ({ date, text, isLast }) => {
  return (
    <li className="relative flex justify-center">
      <div className="grid grid-cols-[120px_auto] gap-8">
        ...
        <div className="relative pb-12">
          ...
          {!isLast && (
            <span className="absolute left-[11px] top-0 h-[calc(100%+3rem)] w-[2px] bg-[#C7B99B]/40" />
          )}
          
          {/* SHORT LINE FOR LAST ITEM */}
          {isLast && (
            <span className="absolute left-[11px] top-0 h-8 w-[2px] bg-[#C7B99B]/40" />
          )}
...
const Timeline = () => {
  ...
  return (
    <section className="min-h-screen flex justify-center items-center pt-20 px-4">
      <div className="w-full max-w-2xl md:max-w-3xl lg:max-w-4xl">

        <h2 className="text-2xl md:text-3xl lg:text-4xl text-[#C7B99B] mb-12 font-light tracking-wide text-center">
          Recent Updates
        </h2>
