...
function Landing() {
  ...
  return (
    <div className="relative min-h-[100svh] w-full max-w-full overflow-x-hidden font-[Questrial] bg-[#0E0E0E]">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center items-center z-[1] scale-[1.75] sm:scale-100"
      >
        ...
        <h1
          className="
            ...
            leading-[42px] sm:leading-[40px] md:leading-[80px]
