  ...
  return (
    <div className="relative min-h-[100svh] w-full max-w-full overflow-x-hidden font-[Questrial] bg-[#0E0E0E]">
        ...
        <MaskLayer>
          ...
          >
            ...
            <div className="pointer-events-none max-w-[800px] text-left">
              <p className="text-[16px] text-black mb-[30px] text-center">
                ABOUT ME
              </p>

              <p className="text-5xl font-extrabold text-black leading-tight">
      ...
      >
        ...
        <p className="text-5xl font-extrabold text-[#C7B99B] leading-tight">
          I’m a curious{" "}
