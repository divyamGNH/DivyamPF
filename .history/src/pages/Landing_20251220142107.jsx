...
function Landing() {
  ...
  return (
    <div className="relative min-h-[100svh] w-full max-w-full overflow-x-hidden font-[Questrial] bg-[#0E0E0E]">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center items-center z-[1] scale-[1.75] sm:scale-1000">
        <p className="text-[12px] sm:text-[14px] md:text-[16px] text-[#C7B99B] mb-4 sm:mb-6 md:mb-[30px]">
          DIVYAM
        </p>
