...
function Landing() {
  ...
  return (
    <div className="relative min-h-[100svh] w-full max-w-full overflow-x-hidden font-[Questrial] bg-[#0E0E0E]">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center items-center z-[1] scale-[1.75] sm:scale-100 pl-5 pr-0"
        // style={{
        //   transform : "translate(-50%,-50%) scale(clamp(1.05, 4vw, 1.25))"
        // }}
      >
        <p className="text-[12px] sm:text-[14px] md:text-[16px] text-[#C7B99B] mb-4 sm:mb-6 md:mb-[30px] text-center">
          DIVYAM
        </p>

        <h1
          className="
            font-extrabold text-[#C7B99B] mt-0 text-center items-center justify-center
            leading-[42px] sm:leading-[60px] md:leading-[80px]
