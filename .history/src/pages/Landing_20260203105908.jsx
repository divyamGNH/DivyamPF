...
const line = {
  ...
  visible: {
    transition: {
      staggerChildren: 0.08, // slow, elegant letter delay
    },
  },
};

// Each letter comes from BELOW its final position
const letter = {
  hidden: {
    opacity: 0,
    y: 28, // ⬅ starts BELOW the final position
  },
  visible: {
    opacity: 1,
    y: 0, // ⬅ settles exactly in place
    transition: {
      duration: 0.9,
      ease: [0.22, 1, 0.36, 1], // ⬅ smooth cubic-bezier (very premium)
    },
  },
};

// Helper for animated text line
