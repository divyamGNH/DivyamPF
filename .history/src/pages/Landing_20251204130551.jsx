  ...
  return (
    <div className="relative h-screen w-full bg-[#0E0E0E] font-[Questrial] overflow-hidden">
      ...
      <motion.div
        ...
        style={{
          zIndex: 1,
          background: "var(--defaultOrange)"   // IMPORTANT FIX
        }}
        animate={{
      ...
      >
        <div>
          <p className="text-[16px] text-amber-700 mb-[30px]">DIVYAM</p>
          <h1 className="text-[100px] font-extrabold text-amber-700 leading-[80px]">
