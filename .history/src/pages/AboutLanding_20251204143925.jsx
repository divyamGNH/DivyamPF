      ...
      <div className="relative h-[100vh] w-full">
        ...
        <MaskLayer>
          ...
          >
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none text-center max-w-[800px]">
        ...
        {/* ---------- FRONT (VISIBLE) TEXT ---------- */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 max-w-[800px] z-[3]">
