  ...
  return (
    <div className="relative w-full font-[Questrial] bg-[#0E0E0E] min-h-screen">
      <div className="relative h-[100vh] w-full">
        ...
        <MaskLayer>
          {/* ---------- INVISIBLE HOVER ZONE (does NOT touch original CSS) ---------- */}
          <div
          ...
          {/* ---------- ORIGINAL HIDDEN TEXT (UNCHANGED) ---------- */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none">
            ...
            <p className="text-5xl font-extrabold text-black mt-0 leading-none max-w-[800px]">
              I’ve shipped code at 2AM, broken production by accident, and Googled the
              same bug five times — but hey, that’s how the magic really happens.
            </p>
          </div>
        </MaskLayer>

        {/* ---------- VISIBLE FRONT TEXT (UNCHANGED) ---------- */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[3] max-w-[800px]">
